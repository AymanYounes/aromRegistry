    ...
    THEMEMASCOT.header = {
        ...
        TM_topnavAnimate: function() {
            if ($window.scrollTop() > (50)) {
                ...
                $(".navbar-sticky-animated").removeClass("mt-40");
            } else {
                $(".navbar-sticky-animated").addClass("animated-active");
                $(".navbar-sticky-animated").addClass("mt-40");
            }
...
var homeCounter = document.getElementById("counter");
if(homeCounter){
...
$('.projects_readmore').click(function(){
    var buttonId = $(this).data('animation');
    var modal_container = $(this).data('modal');

    $('#'+modal_container).removeAttr('class').addClass("project_modal");
    $('#'+modal_container).addClass(buttonId);
